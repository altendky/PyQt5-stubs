...
class pyqtSignal:  # add methods
    ...
    @typing.overload
    def __get__(self, instance: None, owner: typing.Type["QObject"]) -> pyqtBoundSignal:
        ...
    @typing.overload
    def __get__(self, instance: "QObject", owner: typing.Type["QObject"]) -> "pyqtSignal":
        ...
    def __get__(self, instance: typing.Optional["QObject"], owner: typing.Type["QObject"]) -> typing.Union["pyqtSignal", pyqtBoundSignal]: ...
...
class QObject(sip.wrapper):
    ...
    def receivers(self, signal: QtCore.pyqtBoundSignal) -> int: ...
    ...
    @typing.overload
    def findChild(self, type: typing.Type[QObjectT], name: str = ..., options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> QObjectT: ...
    @typing.overload
